...
loadOBJ(Part.SPOTLIGHT, 'obj/bunny.obj', spotlightMaterial, 20, 0, -1, 0, 0,0,0);
...
loadOBJ(Part.TOON, 'obj/bunny.obj', toonMaterial, 20, -2, 0, 5, 0,0,0);

loadOBJ(Part.TOON,'obj/bunny.obj',toonMaterial, 10, -2, 1,3,0,0,0);

loadOBJ(Part.TOON,'obj/LEGO_Man.obj',toonMaterial, 1, 1.3,0,-2.5,0,0,0);
...
function checkKeyboard() {
    if (keyboard.pressed("0"))
        ...
        spotDirectPosition.value.z--
    }else if (keyboard.pressed("s")){
        spotDirectPosition.value.z++
    }else if (keyboard.pressed("a")){
        spotDirectPosition.value.x--
